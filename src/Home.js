      ...
      <div className="home__container">
        ...
        <div className="home__row">
          ...
          <Product
            className="product"
            id="101"
            title="Stand Mixer Kitchen Mixer , 7-Speed 5.5QT Tilt-Head Food Electric Mixer with Dough Hook&Wire Whip&Beater&Stainless Steel Bowl for Most Home Cooks(Black)"
            price={89.99}
          ...
          <Product
            className="product"
            id="102"
            title="Utopia Bedding Comforter Duvet Insert - Quilted Comforter with Corner Tabs - Box Stitched Down Alternative Comforter (King, White)"
            price={279.99}
        ...
        <div className="home__row">
          <Product
            className="product"
            id="103"
            title="LaView Security Cameras for Home + 2X 32GB SD Cards,PT Home Security Camera System with Motion Detection,Two-Way Audio,Night Vision,Indoor WiFi Camera for Baby/pet,Alexa,USA Cloud Service"
            price={39.89}
          ...
          <Product
            className="product"
            id="104"
            title="Rawlings OLB3BAG12 Official League Recreational Use Baseballs, Bag of 12"
            price={25.99}
        ...
        <div className="home__row">
          <Product
            className="product"
            id="105"
            tittle="RUNMUS K8 Gaming Headset for PS4, Xbox One, PC Headset w/Surround Sound, Noise Canceling Over Ear Headphones with Mic & LED Light, Compatible with PS5, PS4, Xbox One, Sega Dreamcast, PC, PS2, Laptop"
            price={18.57}
        ...
        <div className="home__row">
          <Product
            className="product"
            id="109"
            title='Acer Aspire 5 A515-55-56VK, 15.6" Full HD IPS Display, 10th Gen Intel Core i5-1035G1, 8GB DDR4, 256GB NVMe SSD, Intel Wireless WiFi 6 AX201, Fingerprint Reader, Backlit Keyboard, Windows 10 Home'
            price={549.99}
